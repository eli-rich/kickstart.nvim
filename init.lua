...
vim.g.netrw_liststyle = 0 -- thin listing (tree-style is buggy)
...
vim.keymap.set('n', '\\', '<cmd>Lexplore<CR>', { desc = 'Toggle file explorer sidebar' })
vim.keymap.set('n', '<leader>\\', '<cmd>Explore<CR>', { desc = 'Fullscreen file explorer' })
